...
class PelotonConnection:
    ...
    '''
    def get_most_recent_ride_details(self, user_id=None, cookies=None):
        # Get the most recent workout ID
        workout_id = PelotonConnection.__get_workouts__(self, user_id, cookies)[0]
    ...
    '''
    def get_most_recent_ride_info(self, user_id=None, cookies=None):
        workout_id = PelotonConnection.__get_workouts__(self, user_id, cookies)[0]
        workout_url = f"https://api.onepeloton.com/api/workout/{workout_id}"
        workout = self.get(workout_url, cookies)
        created_at = workout.get("created_at")
